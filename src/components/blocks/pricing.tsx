            ...
            >
              ...
              <div className="mt-10 flex flex-col gap-3">
                <Button
                  asChild
                  className={cn(
                    "w-full h-12 md:h-14 rounded-xl text-sm md:text-base font-bold transition-all duration-300 active:scale-95 gap-2 px-4",
                    tier.highlighted 
                ...
                <Button
                  asChild
                  className="w-full h-12 md:h-14 rounded-xl text-sm md:text-base font-bold transition-all duration-300 active:scale-95 bg-white dark:bg-zinc-800 border-2 border-gray-200 dark:border-zinc-700 text-gray-900 dark:text-zinc-100 hover:bg-gray-50 dark:hover:bg-zinc-700/50 shadow-sm"
                >
                  <a 
